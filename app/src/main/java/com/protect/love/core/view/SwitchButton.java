...
public class SwitchButton extends View implements Checkable {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        uncheckCircleColor = 0XffAAAAAA;

        uncheckCircleWidth = dp2pxInt(1.5f);

        uncheckCircleOffsetX = dp2px(10);

        uncheckCircleRadius = dp2px(4);
        ...
        checkedColor = 0Xff51d367;

        borderWidth = dp2pxInt(1);

        checkLineColor = Color.WHITE;

        checkLineWidth = dp2pxInt(1f);
